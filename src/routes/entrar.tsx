    ...
    <div className="grid min-h-screen bg-background text-foreground lg:grid-cols-2">
      <div className="relative flex flex-col px-8 py-8 sm:px-16">
        ...
        <div className="mx-auto flex w-full max-w-sm flex-1 flex-col justify-center">
          ...
          <h1 className="font-heading text-3xl font-medium">Acesse sua conta</h1>
          <p className="mt-2 text-sm text-muted-foreground">Entre para conversar com os produtos da Aura.</p>
